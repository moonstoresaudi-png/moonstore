      ...
      <form onSubmit={handleSave} className="card-soft p-5 sm:p-6 space-y-5">
        <div>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            ...
            <div><label className="text-xs text-foreground/55 mb-1 block">الرقم الضريبي (VAT) — 15 رقم</label><input value={form.vat_number || ''} onChange={e => setForm({ ...form, vat_number: e.target.value })} placeholder="3XXXXXXXXXXXXXX" maxLength={15} className="w-full px-3 py-2.5 rounded-xl border border-border bg-secondary/40 text-sm font-mono focus:border-primary focus:outline-none" dir="ltr" /></div>
