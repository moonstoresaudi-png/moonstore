    ...
    <section id="about" className="py-14 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="order-1 lg:order-2">
          ...
          <h2 className="font-heading text-2xl sm:text-4xl font-extrabold mb-5 flex items-center gap-2 flex-wrap">قصة <img src="/images/brand/logo.png" alt="Moon Store" className="h-12 sm:h-16 w-auto object-contain inline-block" /></h2>
